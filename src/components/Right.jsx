...
const Right = () => {
  ...
  const [balance, setBalance] = useState(false); // Correctly initialize balance state
  ...
  return (
    <>
      {balance ? ( // Render FeesBalance if balance is true
        <FeesBalance />
      ) : (
          ...
          {loading ? ( // Conditional rendering based on loading state
            ...
            <>
              ...
              <div className="text-center">
                <button
                  type="button" // Ensure the button type is correct
                  onClick={() => {
                    setBalance(true); // Set balance to true immediately
                  }}
